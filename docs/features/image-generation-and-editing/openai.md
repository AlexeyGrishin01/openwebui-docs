...
<img src="assets/images/openai-settings.png" alt="Screenshot of the Open WebUI Images settings page with Open AI selected and the API key, model, and image size fields highlighted.">
...
<img src="assets/images/azure-openai-settings.png" alt="Screenshot of the Open WebUI Images settings page with Open AI selected and the API endpoint URL, API version, and API key fields highlighted for Azure OpenAI configuration.">
