...
For complete details on all built-in agentic tools and how to configure them, see the [**Native/Agentic Mode Tools Guide**](features/plugin/tools/index.md#built-in-system-tools-nativeagentic-mode).
...
- `GET /api/v1/files//process/status` - Check file processing status
- `POST /api/v1/knowledge//file/add` - Add files to a knowledge base
...
For detailed examples and proper workflow handling, see the [API Endpoints documentation](getting-started/api-endpoints.md#retrieval-augmented-generation-rag).
