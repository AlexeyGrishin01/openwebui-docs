...
1.  **Administrative Enablement**: Ensure the Memory feature is [enabled globally](#administrative-controls.md) by an administrator and that you have the required permissions.
