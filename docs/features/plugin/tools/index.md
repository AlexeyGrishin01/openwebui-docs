...
<img src="assets/images/chat-controls.png" alt="Chat Controls">
...
- **Advanced Setup**: Learn more about [MCP Support](openapi-servers/mcp.md)
- **Development**: [Writing your own Custom Toolkits](development.md)
