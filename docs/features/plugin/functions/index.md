...
### 1. [**Pipe Function** – Create Custom "Agents/Models"](pipe.md)
...
For a detailed guide, see [**Pipe Functions**](pipe.md).

---

### 2. [**Filter Function** – Modify Inputs and Outputs](filter.md)
...
Check out the full guide for more examples and instructions: [**Filter Functions**](filter.md).

---

### 3. [**Action Function** – Add Custom Buttons](action.md)
...
Learn how to set them up in the [**Action Functions Guide**](action.md).
...
3. Explore the official guides:
   - [Pipe Functions Guide](pipe.md)
   - [Filter Functions Guide](filter.md)
   - [Action Functions Guide](action.md)
