...
- **Get User** (`GET /Users/`): Retrieve user information
- **Update User** (`PUT /Users/`, `PATCH /Users/`): Update user attributes
- **Delete User** (`DELETE /Users/`): Deactivate a user account
- **List Users** (`GET /Users`): List all users with filtering support

### Group Operations

- **Create Group** (`POST /Groups`): Create a new group
- **Get Group** (`GET /Groups/`): Retrieve group information
- **Update Group** (`PUT /Groups/`, `PATCH /Groups/`): Update group membership
- **Delete Group** (`DELETE /Groups/`): Remove a group
...
1. **401 Unauthorized Errors**
   ...
   - Ensure the Authorization header format is: `Bearer `
