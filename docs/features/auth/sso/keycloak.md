...
<img src="assets/images/create-realm.png" alt="create-realm">
...
<img src="assets/images/select-realm.png" alt="select-realm">
...
<img src="assets/images/access-setting-client.png" alt="access-setting-client">
...
5. Select the scope that will contain the group information (e.g., `profile` or `open-webui-dedicated`).
    ...
    <img src="assets/images/scope-client.png" alt="scope-client">
...
<img src="assets/images/mappers-setting-group-client.png" alt="mappers-setting-group-client">
