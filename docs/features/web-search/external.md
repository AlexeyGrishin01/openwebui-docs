...
<img src="assets/images/tutorial_external_search.png" alt="Open WebUI Admin panel showing External Search config">
...
async def external_search(
    ...
    try:
        ...
        print(f"Error during DuckDuckGo search: ")
