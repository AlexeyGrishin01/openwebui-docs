...
Alternatively, set the environment variable [`WEB_SEARCH_TRUST_ENV`](getting-started/env-configuration.md#web_search_trust_env.md):
...
For more details on context window issues, see the [RAG Troubleshooting Guide](rag.md).
...
For a comprehensive list of all web search environment variables, see the [Environment Configuration documentation](getting-started/env-configuration.md#web-search.md).
...
4. Review all [Web Search environment variables](getting-started/env-configuration.md#web-search.md) for additional configuration options
