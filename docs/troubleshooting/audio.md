...
→ See full guides: [Speech-to-Text](category/speech-to-text.md) | [Text-to-Speech](category/text-to-speech.md)
...
→ See full guide: [OpenAI Edge TTS](features/audio/text-to-speech/openai-edge-tts-integration.md)
...
!!! tip
Consider using an external TTS service like [OpenAI Edge TTS](features/audio/text-to-speech/openai-edge-tts-integration.md) or [Kokoro](features/audio/text-to-speech/Kokoro-FastAPI-integration.md) instead of local Transformers TTS to avoid these dependency conflicts.
...
For a complete list of audio environment variables, see [Environment Variable Configuration](getting-started/env-configuration.md#audio).
