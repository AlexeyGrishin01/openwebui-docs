...
✅ Solutions:
- **Always reference the official [environment configuration documentation](getting-started/env-configuration/)** for exact variable names
...
# 1. GET /oauth//login - Should return 302 redirect

# 2. User authenticates with provider

# 3. GET /oauth//callback?code=... - Should return 200 or redirect
