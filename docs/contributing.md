...
**Keep it updated regularly** — the dev branch moves fast! If Docker doesn't work for you, the [Local Development Guide](getting-started/advanced-topics/development.md) is another great option.
...
- **Semantic HTML**: Use semantic HTML elements (``, ``, ``, etc.) to ensure screen readers and other assistive technologies can properly interpret the interface.
