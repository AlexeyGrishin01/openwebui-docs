...
[**→ Learn how to set up Azure CLI Authentication**](azure-cli-auth.md)
...
[**→ Learn how to set up Workload Identity Authentication**](workload-identity-auth.md)
...
- **For local development or Docker deployments**: Start with [Azure CLI Authentication](azure-cli-auth.md)
- **For production AKS deployments**: Use [Workload Identity Authentication](workload-identity-auth.md)
