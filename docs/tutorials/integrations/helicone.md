...
- Your `API Base URL` would be ``https://oai.helicone.ai/v1/``
- The `API KEY` would be your OpenAI API key.

<img src="assets/images/openwebui-helicone-setup_y4ssca.gif" alt="Open WebUI Helicone Setup">
...
<img src="assets/images/CleanShot_2025-04-21_at_17.57.46_2x_wpkpyf.png" alt="Example Helicone Trace">
