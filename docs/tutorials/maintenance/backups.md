...
| Encryption | Modify backup scripts to incorporate encryption at rest. See [Database Encryption with SQLCipher](tutorials/tips/sqlite-database.md#database-encryption-with-sqlcipher) for database-level encryption. |
