...
1. **Install and Run Open WebUI on the New Server**:
   Set up and run Open WebUI using a Docker container. Follow the instructions provided in the [🚀 Getting Started](getting-started/index.md) to install and start the Open WebUI container. Once it's running, stop it before performing the import step.
   ```bash
...
- [SQLite Database Overview](tutorials/tips/sqlite-database.md) - Detailed database schema and SQLCipher encryption setup
- [Backups](tutorials/maintenance/backups.md) - Comprehensive backup strategies for your instance
