...
See all the `Cloud Storage` configuration options in the [Open-WebUI Cloud Storage Config](getting-started/env-configuration#cloud-storage) documentation.
...
<img src="assets/images/amazon-s3-upload-file.png" alt="Upload a file in Open-WebUI">

And confirm that we're getting a response from the selected LLM.

<img src="assets/images/amazon-s3-oui-response.png" alt="Get a response in Open-WebUI">
...
<img src="assets/images/amazon-s3-object-in-bucket.png" alt="Get a response in Open-WebUI">

Using Open-WebUI's swagger docs, we can get all the information related to this file using the `/api/v1/files/` endpoint and passing in the unique ID (4405fabb-603e-4919-972b-2b39d6ad7f5b).

<img src="assets/images/amazon-s3-get-file-by-id.png" alt="Inspect the file by ID">
