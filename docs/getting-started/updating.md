...
**Want to catch bugs before they hit stable releases?** Consider running the [development branch](#using-the-dev-branch-.md) instead. Testing dev builds is one of the most valuable contributions you can make.
...
See the [Persistent Login Sessions](#persistent-login-sessions.md) section below to fix this.
...
For complete environment variable documentation, see [Environment Configuration](getting-started/env-configuration#security-variables).
...
- [Environment Configuration Guide](getting-started/env-configuration) - All environment variables
