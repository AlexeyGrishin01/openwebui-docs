...
If you've saved an unreachable URL and the UI becomes unresponsive, see the [Model List Loading Issues](troubleshooting/connection-error.md#️-model-list-loading-issues-slow-ui--unreachable-endpoints) troubleshooting guide.

<img src="assets/images/connection.png" alt="Llama.cpp Connection in Open WebUI">
...
<img src="assets/images/response.png" alt="Model Chat Preview">
