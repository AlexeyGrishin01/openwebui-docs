...
If your backend is primarily based on the OpenAI standard (like LocalAI or Docker Model Runner), we recommend using the [OpenAI-Compatible Server Guide](getting-started/quick-start/starting-with-openai-compatible.md) for the best experience.
...
However, if you encounter connection issues, the most common cause is a network misconfiguration. You can refer to our [connection troubleshooting guide](troubleshooting/connection-error.md) for help resolving these problems.
...
If you've saved an unreachable URL and can't access Settings to fix it, see the [Model List Loading Issues](troubleshooting/connection-error.md#️-model-list-loading-issues-slow-ui--unreachable-endpoints) troubleshooting guide.

Here’s what the management screen looks like:

<img src="assets/images/manage-ollama.png" alt="Ollama Management Screen">

<img src="assets/images/manage-modal-ollama.png" alt="Ollama Management Screen">
...
<img src="assets/images/selector-ollama.png" alt="Ollama Download Prompt">
...
!!! tip
The `deepseek_r1` parser works for most reasoning models, including Qwen3. If you encounter issues, see our [Reasoning & Thinking Models Guide](features/chat-features/reasoning-models.md) for alternative parsers and detailed troubleshooting steps.
...
If you run into any issues or need more guidance, check out our [help section](troubleshooting/index.md) for detailed solutions. Enjoy using Ollama! 🎉
