...
*   **Model IDs (Filter)**:
    ...
    *   *Set*: Acts as an **Allowlist**. Only the specific model IDs you enter here will be visible to users. Use this to hide older or expensive models.
    ...
    2.  **Enable Model Caching** (`Settings > Connections > Cache Base Model List` or `ENABLE_BASE_MODELS_CACHE=True`). Without caching, page loads can take 10-15+ seconds on first visit due to querying a large number of models. See the [Performance Guide](troubleshooting/performance.md) for more details.
...
If you've saved an unreachable URL and the UI becomes unresponsive, see the [Model List Loading Issues](troubleshooting/connection-error.md#️-model-list-loading-issues-slow-ui--unreachable-endpoints) troubleshooting guide for recovery options.

<img src="assets/images/manage-openai.png" alt="OpenAI Connection Screen">
...
<img src="assets/images/selector-openai.png" alt="OpenAI Model Selector">
...
If you run into issues or need additional support, visit our [help section](troubleshooting/index.md).
